<script>
  ...
  var pointer = 0;
        ...
        function left_popup(table,key)
        {
                ...
                let menu='<div onclick="editor_pass(\'describe '+table+'\',1,0,0,0);describe_mod=1" class=\'mt-3 mb-5\'  style=\'position:absolute;width:100%;top:'+top+'%\'><a href=\'#\' class=\'alert-link\'><h6 class=\'text-light\'>Describe '+table+'</h6></a></font></div>';
        ...
        function status(text,history)
        {
          ...
          if (history == 1 && text.indexOf('panku')==-1){
